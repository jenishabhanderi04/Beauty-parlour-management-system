...
if(isset($_POST['update_product'])){
   ...
   $update_p_name = $_POST['update_p_name'];
    $updateser = $_POST['updateser'];
   $update_p_price = $_POST['update_p_price'];
   $update_p_image = $_FILES['update_p_image']['name'];
   $update_p_image_tmp_name = $_FILES['update_p_image']['tmp_name'];
   $update_p_image_folder = 'uploaded_img/'.$update_p_image;

   $update_query = mysqli_query($conn, "UPDATE `pro` SET name = '$update_p_name',service = '$ser', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
...
<section class="display-product-table">
 ...
 <h1> Manage Package</h1>
      <thead>
         <tr><a href="addpack.php" class="add">Add Package</a></tr>
         <th>package image</th>
         <th>package name</th>
          <th>service</th>
         <th>price</th>
...
$t=mysqli_query($conn,"SELECT * FROM `package`");
...
$select_products=mysqli_query($conn,"select * from package limit $start,$limit");
         ...
         <tr>
            ...
            <td>
               <a href="pack.php?delete=<?php echo $row['id']; ?>" class="del" onclick="return confirm('are your sure you want to delete this?');"> <i></i> delete </a>
            </td>
            <td>
               <a href="pack.php?edit=<?php echo $row['id']; ?>" class="edit"> <i></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" required name="updateser" value="<?php echo $fetch_edit['service']; ?>">
