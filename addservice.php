     ...
     $costErr="";
         ...
         {  
             ...
             if(!PHP_SESSION_ACTIVE)
                session_start();
            $_SESSION['errormsg'] = "Error! You didn't enter the sevice Name";
...
?>
    ...
    <!-- login form -->
        ...
        <div class="slide">
                 ...
                 <div class="L">
                     <div class="l-form">
            <form action="addservice.php" class="form" method="post">
                ...
                <input type="submit" class="form__button" value="Add" name="Add">
            </form>
        </div>
