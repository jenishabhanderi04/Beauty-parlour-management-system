...
<body>
    ...
    <header class="header" id="header">
        <div class="navbar">
            <div class="logo">
                <img src="C:\xampp\htdocs\dhruviproject\beauty\about\logo.svg">
            </div>
            <nav class="nav-menu" id="nav-menu">
                <ul class="nav-list">
                    <li><a href="C:/xampp/htdocs/dhruviproject/beauty/index.html" class="nav-link active">home</a></li>
                    <!-- <li><a href="C:/xampp/htdocs/dhruviproject/beauty/" class="nav-link active"></a></li> -->
    ...
    <div class="wrapper">
        ...
        <div class="about-container">
            ...
            <div class="image-container">
                <img src="C:\xampp\htdocs\dhruviproject\beauty\about\b1.jpg" alt="">
