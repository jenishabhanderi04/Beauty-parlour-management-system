...
<body>
        ...
        <div class="navbar">
            ...
            <nav class="nav-menu" id="nav-menu">
                <ul class="nav-list">
                    ...
                    <li><a href="products123.php" class="nav-link">product</a></li>
    ...
    <section class="home">
        <div class="container">
            ...
            <div class="home-content">
                ...
                <a href="bookappoinmnet/appointment.php" class="btn btn-outline">
        ...
        <div class="package-cards">
            <div class="card">
                ...
                <div class="card-items">
                   ...
                   <a href="package/bronze.html"> <button class="btn">I want this</button></a>
                </div>             
            </div>
            <div class="card">
                <div class="card-title">
                ...
                <div class="card-items">
                    ...
                    <a href="package/silver.html"> <button class="btn">I want this</button></a>
                </div>             
            </div>
            <div class="card">
                <div class="card-title">
                ...
                <div class="card-items">
                    ...
                    <a href="package/gold.html"> <button class="btn">I want this</button></a>
                </div>             
            </div>
            <div class="card">
                <div class="card-title">
                ...
                <div class="card-items">
                    ...
                    <a href="package/diamond.html"> <button class="btn">I want this</button></a>
                </div>             
            </div>
        </div>
    </section>
    ...
    <section class="testimonials">
        ...
        <button ><a href="feedback/feedback.html" class="feedback">Feedback</a></button>
    </section>
