...
$t=mysqli_query($conn,"SELECT id, email,comment,user_id FROM feedback");
...
$query=mysqli_query($conn,"select * from `feedback` limit $start,$limit");

// $sql = "SELECT id, email,comment FROM feedback";
