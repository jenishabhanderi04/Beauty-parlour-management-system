...
$t=mysqli_query($conn,"select * from `bookappointment`");
...
$query=mysqli_query($conn,"select * from bookappointment limit $start,$limit");
...
if (mysqli_num_rows($query) > 0) {
  ...
  while($row = mysqli_fetch_assoc($query)) {
   ...
   echo '<tr>
      ...
      <td><a href="acp.php?uid='.$id.'" class="edit"> <td>accept</td>
      <td><a href="rej.php.?did='.$id.'" class="del">Reject</td>
