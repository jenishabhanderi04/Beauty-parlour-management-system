...
<body>
                ...
                <ul class="nav-list">
                  ...
                  //  session_start();
                    if(!isset($_SESSION['user_id']) || $_SESSION['user_id'] !=true)
                    {
                        ...
                        echo ' <li><a href="udash.php" class="nav-link">Dashboard</a></li>';
    ...
    <section class="home">
        <div class="container">
            ...
            <div class="home-content">
                ...
                <a href="apooin.php" class="btn btn-outline">
        ...
        <!-- <div class="package-cards">
            ...
            <div class="card">
                ...
                <div class="card-items">
                    ...
                    <a href="packages.php"> <button class="btn">I want this</button></a>
                </div>             
            </div>
           <!--  <div class="card">
                <div class="card-title">
    ...
    <section class="testimonials">
        ...
        <center>
        <button><a href="feedback.php" class="feedback">Feedback</a></button>
        </center>
    </section>
