...
$t=mysqli_query($conn,"SELECT rid,name,email,address,dob,number,password from registration");
...
$query=mysqli_query($conn,"select * from registration limit $start,$limit");
...
// $sql = "SELECT rid,name,email,address,dob,number,password from registration";
