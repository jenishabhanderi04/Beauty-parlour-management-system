    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide " data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/project/beauty/bg1.jpg" class="d-block w-100" alt="Slide 1" style="height:70vh">
        ...
        <table class="table">
            ...
            <tbody class="table-group-divider">
                <tr class="align-middle">
                    <td>
                        <img class="border rounded me-2" src="/project/beauty/p1.jpg" alt="garnier" width="70" height="70">
                    ...
                    <td>
                        <button class="border-0 bg-white">
                            <img src="/project/beauty/del.png" alt="Delete" width="20" height="20">
                        </button>
                    </td>
                </tr>
                <tr class="align-middle">
                    <td>
                        <img class="border rounded me-2" src="/project/beauty/p4.jpg" alt="burger" width="70" height="70">
