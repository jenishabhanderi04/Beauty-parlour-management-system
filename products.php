<?php
 ...
 $user_id = $_SESSION['user_id'];
   ...
   $select_cart = mysqli_query($conn, "SELECT * FROM `cart` WHERE `cid` = '$rid' ");
   ...
   if(mysqli_num_rows($select_cart) > 0){
      ...
      $insert_product = mysqli_query($conn, "INSERT INTO `cart`(name, price, image, quantity,user_id,pid) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity','$rid',28)");
                 ...
                 <ul class="nav-list">
                  ...
                  //  session_start();
                    if(!isset($_SESSION['user_id']) || $_SESSION['user_id'] !=true)
                    {
                        ...
                        echo ' <li><a href="cart.php" class="nav-link">View Cart</a></li>';
