...
$t=mysqli_query($conn,"SELECT * FROM bookappointment where user_id = '$rid'");
...
$query=mysqli_query($conn,"select * from `bookappointment` where user_id = '$rid' limit $start,$limit");
